...
const JobCard = () => {
  return (
    <div className="job flex items-center gap-4 w-full shadow-md bg-white rounded p-3 cursor-pointer">
      <div className="job__logo">
        <Image
          src="https://remotive.com/job/1245966/logo"
          alt="company logo"
          width={90}
          height={90}
        />
      ...
      <div className="job__info grid grid-cols-1 md:grid-cols-2 w-full">
        <div className="flex flex-col justify-between flex-1">
          <span className="text-xs font-bold text-primary">Mimo</span>
          <span className="md:my-3 text-lg text-primary">Curriculum Owner</span>
        ...
        <div className="flex flex-col gap-2 sm:gap-4 items-start sm:flex-row sm:items-end justify-start md:justify-end mt-5 md:mt-0">
          <div className="flex items-center center gap-2">
            ...
            <span className="text-xs text-accent font-medium">Worldwide</span>
          </div>
